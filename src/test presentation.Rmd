...
# Work flow
#### Packages and methods used in this project
...
Plot displaying each patient and for which visits data is available
...
```{r, message=FALSE, echo=FALSE, dpi=150, out.width = '250px'}
